...
class AuthRepository extends BaseRepository {
     ...
     * Realiza o login via e-mail e senha, disparando o erro bruto para tratamento no Service.
     */
    async signInWithEmail(email, password) {
        try {
            ...
            if (error) {
                // Logamos internamente para auditoria; o Service decide a resposta ao cliente
     ...
     * Garante que o registro exista no banco local. Utilizado no Auto-Healing caso o trigger falhe.
     */
    async createProfileSafely(profileData) {
        ...
        try {
            ...
            // Inicializa a carteira digital para o novo perfil se necessário
     ...
     * Valida se o username já está em uso no ecossistema local.
     */
